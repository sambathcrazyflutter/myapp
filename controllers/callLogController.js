...
//connection.query(sql, true, (error, results, fields) => {
  ...
  exports.getCallLog =  function(request, response, next) {
  
    var uid = request.user.uid;

     let sql = `CALL getCallLog( ? )`;
     connection.query(sql,[uid],(error, results, fields) => {
        ...
        let year = date_ob.getFullYear();
            ...
            mkdir(dir);
        fs.appendFile('./Request_response_data/'+day_o+'/callLogDetail.txt', JSON.stringify(results, null, 4), function (err) {
